...
This template ships a **default** root `README.md` and `CHANGELOG.md` so GitHub shows overview and release notes. After you run `init_project.sh`, the scaffold step copies the framework’s `README.md` and `CHANGELOG.md` from the generated project onto the repository root (replacing these files), matching typical framework-first workflows.
...
- [Bootstrap and migration flow](docs/operations/bootstrap-flow.md)
...
### What happens to this root `README.md` after `init_project.sh`?
