...
- Maintain an `Unreleased` section at the top of **`CHANGELOG.md`** at the repository root **and** keep [`docs/operations/tooling-changelog.md`](../operations/tooling-changelog.md) in sync (same content; the docs copy is retained for existing links).
...
- Update `CHANGELOG.md` at the repository root (and the mirror under `docs/operations/tooling-changelog.md`) manually during feature/fix work.
