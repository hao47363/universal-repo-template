...
The **Prepare** job’s first step validates `tooling_repository` and `tooling_ref` (non-empty, `owner/repo` shape, rejects path traversal). For YAML examples and private-tooling PAT setup, see the [Central tooling README](../../README.md).
