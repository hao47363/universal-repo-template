...
conventional_types="$(sh ./governance-pack/scripts/get_config_value.sh governance.conventional_types "feat,fix,chore,docs,refactor,test,perf,ci,build,style,revert")"
